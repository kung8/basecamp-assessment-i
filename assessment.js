...
var trueFaveNum = favNum === trueFaveNum;
...
If(notHakeem != myName){return true};
else {return false};
...
function greeter (name, num){return "Hi! I am " + name + " and I am " + num + " years old"};